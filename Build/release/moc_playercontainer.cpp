...
#include "../../RemiGUI2_3/RemiGUI2asd/RemiGUI/playercontainer.h"
...
void PlayerContainer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->onAddingCardtoGroup(); break;
        case 3: _t->onEmptyGroup(); break;
        default: ;
        }
...
// SIGNAL 2
void PlayerContainer::onAddingCardtoGroup()
{
    QMetaObject::activate(this, &staticMetaObject, 2, Q_NULLPTR);
}

// SIGNAL 3
void PlayerContainer::onEmptyGroup()
{
